...
export default function Mensajes() {
    ...
    // ============================================================
    // ABRIR AUTOMÁTICAMENTE EL CHAT DESDE EL PERFIL PÚBLICO
    // ============================================================
    useEffect(() => {
        ...
        if (usuarioId) {
            ...
            setChatPrivadoAbierto({
                id: usuarioId,
                nombre: nombre || "Usuario"
            });

            // Limpiamos el state para que al recargar no vuelva a abrirlo
        ...
        const cargarConversaciones = async () => {
            try {
                const { data } = await api.get(
                    "/mensajes-privados/conversaciones"
                );
    ...
    }, [tab, chatPrivadoAbierto]);

    // ============================================================
    // CARGAR USUARIOS PARA NUEVA CONVERSACIÓN
    // ============================================================
    useEffect(() => {
            ...
            >
                            ...
                            {equipos.map((eq) => (
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        >
                                            {eq.miembros?.length
                                                ? `${eq.miembros.length} integrantes`
                                                : "Equipo"}
                                        </div>
                                    </div>
                                </div>
                ...
                {tab === "privados" && (
                    ...
                    >
                        ...
                        {/* CHAT DE LA PERSONA SELECCIONADA */}
                        <GlassCard
                            style={{
                                padding: 0,
                                overflow: "hidden",
